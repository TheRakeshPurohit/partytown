...
To hide them while debugging, filter them out of the network tab with [`-url:proxytown`](https://developer.chrome.com/docs/devtools/network/reference#invert-filters) in Chrome DevTools.
